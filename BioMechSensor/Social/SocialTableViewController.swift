...
class SocialTableViewController: UITableViewController {
    ...
    var imageList = ["website","linkedin","facebook", "twitter", "instagram", "youtube"]
    var titleList = ["Website","LinkedIn","Facebook", "Twitter","Instagram","YouTube"]
    
    var spacingBetweenCells: CGFloat = 5.0
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "showDetail" {
            ...
            if let indexPath = self.tableView.indexPathForSelectedRow {
                dvc.sendData = titleList[indexPath.row] as String
            }
  }
}
}
